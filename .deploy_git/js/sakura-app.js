...
$(document).ready(function () {
  ...
  $('.skin-menu #white-bg').click(function () {
    ...
    $('.pattern-center-sakura').removeClass('pattern-center-sakura').addClass('pattern-center-sakura')
    $('.headertop-bar-sakura').removeClass('headertop-bar-sakura').addClass('headertop-bar-sakura')
    $('#banner_wave_1').removeClass('banner_wave_hide_fit_skin')
    $('#banner_wave_2').removeClass('banner_wave_hide_fit_skin')
    closeSkinMenu()
